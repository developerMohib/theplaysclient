...
export const games : Game[] = [
  {
    ...
    shortDescription:
      "Next-gen football simulation with realistic gameplay.",
    version: "1.0.0",
...

  {
    ...
    shortDescription:
      "Open-world racing adventure with realistic driving.",
    version: "2.5.1",
...

  {
    ...
    shortDescription:
      "Ultimate wrestling action with WWE superstars.",
    version: "1.2.0",
    publisher: "2K",
...

  {
    ...
    shortDescription:
      "Massive open-world crime adventure experience.",
    version: "3.0.0",
    publisher: "Rockstar",
...

  {
    ...
    shortDescription:
      "Epic samurai adventure with cinematic combat.",
    version: "1.0.5",
...

  {
    ...
    shortDescription:
      "Action-packed superhero experience in NYC.",
    version: "2.0.0",
    publisher: "Sony Interactive",
    multiplayer: false,
